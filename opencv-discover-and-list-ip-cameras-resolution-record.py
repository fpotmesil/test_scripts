...
# Open RTSP stream with OpenCV and record
def open_rtsp_stream(rtsp_url, output_filename):
    ...
    if fps <= 0:  # Some cameras don't report FPS correctly
        fps = 25.0
    ...
    print(f"✅ Streaming and recording to: {output_filename}")
...
if __name__ == "__main__":
    ...
    if rtsp_url:
        ...
        output_file = os.path.join(output_dir, f"camera_record_{timestamp}.avi")

        open_rtsp_stream(rtsp_url, output_file)
