...
#vgg16_model = models.vgg16(pretrained=True, weights=VGG16_Weights.DEFAULT).to(device)
#vgg16_model = models.vgg16(pretrained=True).to(device)
vgg16_model = models.vgg16(weights='DEFAULT').to(device)

#summary(vgg16_model, torch.zeros(1,3,224,224))
